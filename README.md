...
Отклонение от истинного значения все еще были большими. Чтобы улучшить точность на предсказаниях был обучена метамодель в виде RandomForest. Лес показал себя лучше, чем другие бустинги или Ridge,Lasso,ElasticNet. Кроме предсказаний 4 моделей, мета модель обучилась на следующих признаках:
